...
public class Menu extends javax.swing.JFrame {
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(tMenu, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 178, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void bTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bTambahActionPerformed
        if (tMenu.getText().equals("") | tHarga.getText().equals("")) {
            ...
            try {
                ...
                cn.createStatement().executeUpdate("insert into menu values"+"(null,'"+tMenu.getText()+"','"+tHarga.getText()+"')");
    ...
    private void bEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEditActionPerformed
        if (tMenu.getText().equals("") | tHarga.getText().equals("")) {
            ...
            try {
                Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/cafe","root","");
                cn.createStatement().executeUpdate("UPDATE menu set nama_menu='"+ tMenu.getText()+"',harga_menu ='"+tHarga.getText()+"' where menu. kode ='"+lKode.getText()+"'");
    ...
    private void tabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelMouseClicked
        ...
        if(i>-1){
            ...
            tMenu.setText(model.getValueAt(i,1).toString());
            tHarga.setText(model.getValueAt(i,2).toString());
        }
